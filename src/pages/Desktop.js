...
export default class Desktop extends Component {
    constructor(props){
        super(props);
        this.state = {isEcommerceOpen: false, isGymOpen: false, isResOpen: false, isPortOpen: false, isModalOpen: false, isNetflixOpen: false}
        ...
        this.toggleNetflix = this.toggleNetflix.bind(this)
    ...
    closeModal(){
        this.setState({isEcommerceOpen: false, isGymOpen: false, isPortOpen: false, isResOpen: false, isModalOpen: false, isNetflixOpen: false})
    }
    toggleNetflix() {
        this.setState({isNetflixOpen: !this.state.isNetflixOpen, isModalOpen: !this.state.isModalOpen})
    }
                            ...
                            <div className="modal-grid">
                                ...
                                <div className="modal-info">
                                    <div className="project-header">
                                        ...
                                        <AiOutlineClose className="modal-close" onClick={this.toggleNetflix}/>
                                    </div>
                                    <ul className="project-technology">
                                        <li>HTML</li>
